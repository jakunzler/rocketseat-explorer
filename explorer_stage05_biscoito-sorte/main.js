...
const stringLuckText = document.querySelector(".stringLuckText")
...
// Eventos
tryLuck.addEventListener('click', handleTryClick);
...
function handleTryClick() {
    toggleScreen()
    stringLuckText.textContent = arrayLuckText[randomNumber];
}

function handleResetClick() {
    toggleScreen()
    randomNumber = Math.round(Math.random() * 60);
}
